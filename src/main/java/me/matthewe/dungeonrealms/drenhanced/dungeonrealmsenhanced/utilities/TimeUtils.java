...
public class TimeUtils {
    ...
    public static String formatTimeToHHMMSS(final long millis, TextFormatting unitColor, TextFormatting numberColor, boolean bold) {
        ...
        if (hours > 0) {
            stringBuilder.append(numberColor).append(hours).append(unitColor);
            if (bold) {
        ...
        if (minutes > 0) {
            stringBuilder.append(numberColor).append(minutes).append(unitColor);
            if (bold) {
                stringBuilder.append(TextFormatting.BOLD);
            }
        ...
        if (seconds > 0) {
            stringBuilder.append(numberColor).append(seconds).append(unitColor);
            if (bold) {
                stringBuilder.append(TextFormatting.BOLD);
            }
